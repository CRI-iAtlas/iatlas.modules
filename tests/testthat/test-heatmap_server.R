...
#     readRDS("/home/alamb/repos/iatlas-app/inst/test_rds_files/pcawg_immune_subtype_cohort_obj.rds")
# })
#
...
#       session$setInputs("response_feature_choice" = "Eosinophils")
...
#       expect_equal(response_feature(), "Eosinophils")
#       expect_type(scatterplot_data(), "list")
#       expect_named(
#         scatterplot_data(),
#         c("sample", "group", "TCR Richness", "Eosinophils")
#       )
#
